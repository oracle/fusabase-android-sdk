...
/**
 * Represents a IDCS authentication credential.
 *<p>
 * This class extends the AuthCredential abstract class and provides additional functionality for handling IDCS authentication.
 *</p>
 */
public class IDCSAuthCredential extends AuthCredential{
    @NonNull
    ...
    /**
     * Constructs a new IDCSAuthCredential object.
     *
     ...
     */
    protected IDCSAuthCredential(@NonNull String provider,
